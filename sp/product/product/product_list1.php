             ...
             <div class="filters d-flex justify-content-between">
                ...
                <form method="GET" action="product_list.php" class="form-inline">
                    ...
                    <select id="price_filter" name="price_filter" class="form-control mr-2">
                        ...
                        <option value="under_1000" <?php if (isset($_GET['price_filter']) && $_GET['price_filter'] == 'under_1000') echo 'selected'; ?>>
                            <?php echo number_format(1000); ?> 元以下
                        </option>
                        <option value="1000_2000" <?php if (isset($_GET['price_filter']) && $_GET['price_filter'] == '1000_2000') echo 'selected'; ?>>
                            <?php echo number_format(1000); ?> - <?php echo number_format(2000); ?> 元
                        </option>
                        <option value="above_2000" <?php if (isset($_GET['price_filter']) && $_GET['price_filter'] == 'above_2000') echo 'selected'; ?>>
                            <?php echo number_format(2000); ?> 元以上
                        </option>
                    </select>
