...
<body>
    ...
    <main class="main-content">
        <div class="container">
            <div class="d-flex flex-column justify-content-between align-items-start  pt-5 row content-wrapper">
                <div class="d-flex justify-content-between mb-3 col-12 ">
                    <a href="product_list.php" class="text-decoration-none text-dark">
                        <p class="m-0 d-inline h2">商品管理 <span class="text-sm fs-5"> / 商品列表</span></p>
                    </a>
                    <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#addProductModal"><i class="fa-solid fa-plus"></i></button>
                </div>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="form-group ">
                                        <label for="product_name" class="my-2">商品名稱 :</label>
                                        <input type="text" class="form-control" id="product_name" name="product_name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="brand_id" class="my-2">品牌 :</label>
                                    ...
                                    <div class="form-group">
                                        <label for="main_category_id" class="my-2">部位 :</label>
                                    ...
                                    <div class="form-group">
                                        <label for="sub_category_id" class="my-2">品項 :</label>
                                        <select class="form-control" id="sub_category_id" name="sub_category_id" required>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="color" class="my-2">色號 :</label>
                                        <input type="text" class="form-control" id="color" name="color" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="price" class="my-2">價格 :</label>
                                        <input type="number" class="form-control" id="price" name="price" step="0.01" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="description" class="my-2">商品描述 :</label>
                                        <input type="text" class="form-control" id="description" name="description" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="images" class="mt-3">上傳圖片 :</label>
                ...
                <hr>
                <div class="my-2 py-1 d-flex justify-content-between">
                    ...
                    <div class="pagination">
                        ...
                        if ($currentGroup > 1) {
                            ...
                            echo "<li class='page-item'><a class='page-link' href='product_list.php? page=$prevGroupPage$keywordParam$priceFilterParam'>上一頁</a></li>";
                        }

                        for ($i = $startPage; $i <= $endPage; $i++) {
                            if ($i == $page) {
                                echo "<li class='page-item'><a class='page-link' class='active' href='javascript:void(0);'>$i</a></li>";
                            } else {
                                echo "<li class='page-item'><a class='page-link' href='product_list.php?page=$i$keywordParam$priceFilterParam'>$i</a></li>";
                            }
                        }

                        if ($endPage < $totalPages) {
                            $nextGroupPage = $endPage + 1;
                            echo "<li class='page-item'><a class='page-link' href='product_list.php?page=$nextGroupPage$keywordParam$priceFilterParam'>下一頁</a></li>";
                        }
                        ?>
                    </div>

                    <div class="col-4">
                        <form method="GET" action="product_list.php" class="d-flex input-group">
                    ...
                    <div class="col-3">
                        <form method="GET" action="product_list.php" class="d-flex align-items-center">
                            <input type="hidden" name="keyword" value="<?php echo isset($_GET['keyword']) ? htmlspecialchars($_GET['keyword']) : ''; ?>">
                            <label for="price_filter" class="text-nowrap pe-2">依價格篩選 : </label>
                            <div class="input-group">
                                ...
                                <button type="submit" class="btn btn-dark"><i class="fa-solid fa-filter-circle-dollar"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($rows as $row): ?>
                                <tr>
                                    ...
                                    <td class="gap-3">
                                        <a href="product.php?id=<?= htmlspecialchars($row['id']) ?>&color_id=<?= htmlspecialchars($row['color_id']) ?>" class="btn btn-outline-danger btn-md me-2">
                                            <i class="fa-regular fa-eye"></i>
                                        </a>
                                        <a href="#" class="btn btn-outline-danger btn-md" onclick="confirmDelete(<?= htmlspecialchars($row['id']) ?>, '<?= htmlspecialchars($row['product_name']) ?>')">
